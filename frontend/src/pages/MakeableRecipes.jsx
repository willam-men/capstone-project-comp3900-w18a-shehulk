...
export default function MakeableRecipes() {
  ...
  async function loadRecipes() {
    const data = await fetchData("GET", "api/makeable_recipes", {}, token);
    return data.recipes;
  }
      ...
      {loading ? (
        ...
        <Box>
          <Typography variant="h4" style={titleStyle}>
            Recipes Makeable With Your Pantry
          </Typography>
          ...
          {isRecipes ? (
            ...
            <Box>
              <Typography>
                No recipes are makeable from pantry ingredients.
              </Typography>
              <Button style={buttonStyle} onClick={() => navigate("/pantry")}>
